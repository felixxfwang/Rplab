<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddArticle.aspx.cs" Inherits="RPLab.Admin.AddArticle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="adminContent" runat="server">
    <div class="content">
        ...
        <div id="account">
            ...
            <div class="item">
                <div class="label">
                    <asp:Label ID="Label2" runat="server">作者</asp:Label>
                </div>
                <div class="input">
            ...
            <div class="item">
                <div class="label">
                    <asp:Label ID="Label3" runat="server">时间</asp:Label>
                </div>
                <div class="input">
                    <asp:TextBox runat="server" ID="DateTimePicker" ToolTip="yyyy/MM/dd"></asp:TextBox>
                    <asp:CompareValidator runat="server" ID="Validator" Type="Date" ForeColor="Red" ErrorMessage="请以正确的时间格式进行填写,比如2012/12/25" ControlToValidate="DateTimePicker" Operator="DataTypeCheck"></asp:CompareValidator>
                </div>
            </div>
            <div class="item">
